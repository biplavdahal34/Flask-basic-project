...
from flask_project.forms import Registration, Login, UpdateAccount, New_post, Request_reset_form, Password_reset_form
...
@app.route("/reset_request/<string:token>",methods=['GET','POST'])
